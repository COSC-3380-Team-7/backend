...
function router(req, res) {
	...
	if (url.startsWith("/manager/exhibit_habitats") && method === "GET") {
	...
	} else if (url.startsWith("/manager/habitat_animals") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/manager/exhibit") && method === "GET") {
		// split the URL into parts i.e [ '', 'manager', 'exhibit' ]
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/manager/exhibit") && method === "POST") {
		exhibitController.createExhibit(req, res);
	} else if (url.startsWith("/manager/exhibit") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/manager/habitat") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/manager/habitat") && method === "POST") {
		habitatController.createHabitat(req, res);
	} else if (url.startsWith("/manager/habitat") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/manager/animal") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/manager/animal") && method === "POST") {
		animalController.createAnimal(req, res);
	} else if (url.startsWith("/manager/animal") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/manager/maintenance_report") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
		if (parts.length >= 4) {
	...
	} else if (url.startsWith("/manager/event_category") && method === "GET") {
		eventController.getEventCategories(req, res);
	} else if (url.startsWith("/manager/event") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/manager/event") && method === "POST") {
		eventController.createEvent(req, res);
	} else if (url.startsWith("/manager/event") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
		if (parts.length >= 4) {
	...
	} else if (url.startsWith("/manager/ticket_type") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/manager/ticket_type") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
		if (parts.length >= 4) {
	...
	} else if (url.startsWith("/manager/ticket_type") && method === "POST") {
		ticketController.createTicketPricing(req, res, ticket_type_id);
	} else if (url.startsWith("/manager/ticket") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/manager/ticket") && method === "POST") {
		ticketController.createTicket(req, res);
	} else if (url.startsWith("/manager/ticket") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/manager/vet_report") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/manager/vet_report") && method === "POST") {
		vetReportsController.createVetReport(req, res);
	} else if (url.startsWith("/manager/vet_report") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/manager/department_employee") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/manager/department_manager") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/manager/department_manager") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
		...
		url.startsWith("/manager/department_manager") &&
		method === "DELETE"
	) {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/manager/employee") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/manager/department") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/manager/department") && method === "POST") {
		departmentController.createDepartment(req, res);
	} else if (url.startsWith("/manager/department") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/manager/employee") && method === "POST") {
		employeeController.createEmployee(req, res);
	} else if (url.startsWith("/manager/employee") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/manager/gift_shop") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/manager/gift_shop") && method === "POST") {
		giftShopController.createGiftShop(req, res);
	} else if (url.startsWith("/manager/gift_shop") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/manager/merchandise") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/manager/merchandise") && method === "POST") {
		merchandiseController.createMerchandise(req, res);
	} else if (url.startsWith("/manager/merchandise") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/manager/occupations") && method === "GET") {
		// For getting all occupations
		occupationController.getAllOccupations(req, res);
	} else if (url.startsWith("/manager/occupations") && method === "POST") {
		// For creating a new occupation
		occupationController.createOccupation(req, res);
	} else if (url.startsWith("/manager/occupations") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/manager/visitor") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/manager/visitor") && method === "POST") {
		visitorController.createVisitor(req, res);
	} else if (url.startsWith("/manager/visitor") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/manager/login") && method === "POST") {
