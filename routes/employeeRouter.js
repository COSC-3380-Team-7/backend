...
function router(req, res) {
	...
	if (url.startsWith("/employee/exhibit_habitats") && method === "GET") {
	...
	} else if (url.startsWith("/employee/habitat_animals") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/employee/exhibit") && method === "GET") {
		// split the URL into parts i.e [ '', 'employee', 'exhibit' ]
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/employee/exhibit") && method === "POST") {
		exhibitController.createExhibit(req, res);
	} else if (url.startsWith("/employee/exhibit") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/employee/habitat") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/employee/habitat") && method === "POST") {
		habitatController.createHabitat(req, res);
	} else if (url.startsWith("/employee/habitat") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/employee/animal") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/employee/animal") && method === "POST") {
		animalController.createAnimal(req, res);
	} else if (url.startsWith("/employee/animal") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/employee/maintenance_report") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
		if (parts.length >= 4) {
	...
	} else if (url.startsWith("/employee/event_category") && method === "GET") {
		eventController.getEventCategories(req, res);
	} else if (url.startsWith("/employee/event") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/employee/event") && method === "POST") {
		eventController.createEvent(req, res);
	} else if (url.startsWith("/employee/event") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
		if (parts.length >= 4) {
	...
	} else if (url.startsWith("/employee/ticket_type") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/employee/ticket_type") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
		if (parts.length >= 4) {
	...
	} else if (url.startsWith("/employee/ticket_type") && method === "POST") {
		ticketController.createTicketPricing(req, res, ticket_type_id);
	} else if (url.startsWith("/employee/ticket") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/employee/ticket") && method === "POST") {
		ticketController.createTicket(req, res);
	} else if (url.startsWith("/employee/ticket") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/employee/vet_report") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/employee/vet_report") && method === "POST") {
		vetReportsController.createVetReport(req, res);
	} else if (url.startsWith("/employee/vet_report") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/employee/department_employee") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/employee/department_manager") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/employee/department_manager") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
		...
		url.startsWith("/employee/department_manager") &&
		method === "DELETE"
	) {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/employee/employee") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/employee/department") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/employee/department") && method === "POST") {
		departmentController.createDepartment(req, res);
	} else if (url.startsWith("/employee/department") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/employee/employee") && method === "POST") {
		employeeController.createEmployee(req, res);
	} else if (url.startsWith("/employee/employee") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/employee/gift_shop") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/employee/gift_shop") && method === "POST") {
		giftShopController.createGiftShop(req, res);
	} else if (url.startsWith("/employee/gift_shop") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/employee/merchandise") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/employee/merchandise") && method === "POST") {
		merchandiseController.createMerchandise(req, res);
	} else if (url.startsWith("/employee/merchandise") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/employee/occupations") && method === "GET") {
		// For getting all occupations
		occupationController.getAllOccupations(req, res);
	} else if (url.startsWith("/employee/occupations") && method === "POST") {
		// For creating a new occupation
		occupationController.createOccupation(req, res);
	} else if (url.startsWith("/employee/occupations") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/employee/visitor") && method === "GET") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/employee/visitor") && method === "POST") {
		visitorController.createVisitor(req, res);
	} else if (url.startsWith("/employee/visitor") && method === "PUT") {
		const parts = parsedUrl.pathname.split("/");
	...
	} else if (url.startsWith("/employee/login") && method === "POST") {
